...
else
{
	...
	$TABLEUSER = $pdo->exec("CREATE TABLE IF NOT EXISTS users(id int(11) AUTO_INCREMENT PRIMARY KEY NOT NULL, login varchar(255) UNIQUE NOT NULL, email varchar(255) NOT NULL UNIQUE, mdp varchar(255) NOT NULL);");
	...
	$pdo->exec("DROP TABLE IF EXIST pictures");
	$TABLEPICTURE = $pdo->exec("CREATE TABLE IF NOT EXISTS pictures(id INT(11) AUTO_INCREMENT PRIMARY KEY NOT NULL, creation DATETIME NOT NULL  DEFAULT NOW() , deleted BOOLEAN NOT NULL DEFAULT 0, createur VARCHAR(255) NOT NULL);");
	echo $TABLEPICTURE;
	echo "Tables: PICTURES created".PHP_EOL;
